...
5. [Bottles](#bottles)
6. [Special Crafts](#special-crafts)
7. [Recipe Progression by Day](#recipe-progression-by-day)
8. [Use Cases — Ammo Reference](#use-cases--ammo-reference)
9. [Usage Balance](#usage-balance)
...
|------|------|-----|--------|--------|----------|-----------------|
| 🧊 | Frost Bottle | Day 5 | 🎂 Berry Cake ×8 + 🧪 Vial Lv1 ×1 + 🔩 Iron ×2 | ❄ Slow 30–70% · Freeze 30% · +50% dmg taken | 12s | SMG · AR |
| ⚡ | Rapidfire Bottle | Day 6 | 🍔 Burger Berry ×8 + 🧪 Vial Lv1 ×1 + 🔩 Iron ×2 | 🏃 +50% fire rate | 8s | AR · SMG · Shotgun |

### Tier 2 (Day 10–12)

| Icon | Name | Day | Recipe | Effect | Duration | Compatible Guns |
|------|------|-----|--------|--------|----------|-----------------|
| 🎯 | Crit Bottle | Day 11 | 🍲 Tomato Soup ×8 + 🧪 Vial Lv1 ×1 + 🔩 Iron ×2 | ⚡ 100% crit · ×2 damage | 10s | AR · Shotgun · Sniper |
